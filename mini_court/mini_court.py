...
sys.path.append('../')
import constants 
from utils import convert_meters_to_pixels, convert_pixel_to_meters
...
class MiniCourt():
        ...
        def set_court_drawing_key_points(self):
            ...
            # point 1
            drawing_key_points[2], drawing_key_points[3] = int(self.court_end_x), int(self.court_end_y)
            
            # point 2
            drawing_key_points[4] = int(self.court_start_x)
            drawing_key_points[5] = self.court_start_y + convert_meters_to_pixels(constants.HALF_COURT_LINE_HEIGHT * 2)
